...
<section class="hero">
        <div class="hero-content">
            <h1>Príslušenstvo</h1>
            <p>Objavte našu širokú ponuku fitness príslušenstva pre vaše tréningy.</p>
        </div>
    </section>

    <div class="container">
        <h2>Naše najlepšie fitness pomôcky</h2>
        <section class="products-section">
            <div class="product-card">
                <h3>Činky</h3>
                <p>Ideálne pre silový tréning.</p>
                <a href="#" class="cta-button-small">Zobraziť viac</a>
            </div>
            <div class="product-card">
                <h3>Jógová podložka</h3>
                <p>Pohodlná a protisklzová podložka na jogu.</p>
                <a href="#" class="cta-button-small">Zobraziť viac</a>
            </div>
        </section>
    </div>

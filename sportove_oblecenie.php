...
<section class="hero">
        <div class="hero-content">
            <h1>Športové oblečenie</h1>
            <p>Vyberte si z našej kolekcie pohodlného športového oblečenia.</p>
        </div>
    </section>

    <div class="container">
        <h2>Naše najlepšie tréningové oblečenie</h2>
        <section class="products-section">
            <div class="product-card">
                <h3>Športové tričko</h3>
                <p>Pohodlné a priedušné tričko na cvičenie.</p>
                <a href="#" class="cta-button-small">Zobraziť viac</a>
            </div>
            <div class="product-card">
                <h3>Tréningové šortky</h3>
                <p>Ideálne na akýkoľvek typ tréningu.</p>
                <a href="#" class="cta-button-small">Zobraziť viac</a>
            </div>
        </section>
    </div>
